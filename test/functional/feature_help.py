...
"""Verify that starting 405Coind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start 405Coind with -h for help text")
        ...
        self.log.info("Start 405Coind with -version for version information")
        ...
        self.log.info("Start 405Coind with -fakearg  to make sure it does not start")

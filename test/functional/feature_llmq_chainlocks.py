...
from test_framework.test_framework import 405CoinTestFramework
...
class LLMQChainLocksTest(405CoinTestFramework):
    def set_test_params(self):
        self.set_405Coin_test_params(6, 5, fast_dip3_enforcement=True)

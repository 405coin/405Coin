...
This mechanism has been integrated into Bitcore-Node-405Coin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/raptor3um/insight-api-405Coin#web-socket-api](https://github.com/raptor3um/insight-api-405Coin#web-socket-api)
* API: [https://github.com/raptor3um/insight-api-405Coin#instantsend-transactions](https://github.com/raptor3um/insight-api-405Coin#instantsend-transactions)

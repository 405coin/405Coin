...
* 405Coin.conf: contains configuration settings for 405Coind or 405Coin-qt
* 405Coind.pid: stores the process id of 405Coind while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by 405Coind or 405Coin-qt

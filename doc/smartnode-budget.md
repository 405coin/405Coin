...
405Coin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
Format: ```mngovernance prepare proposal-name url payment-count block-start 405Coin-address monthly-payment-405Coin```
...
Format: ```mngovernance submit proposal-name url payment-count block-start 405Coin-address monthly-payment-405Coin fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single smartnode (using 405Coin.conf setup)

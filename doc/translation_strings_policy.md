...
This document provides guidelines for internationalization of the 405Coin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `405Coin_en.ts` remains unchanged.

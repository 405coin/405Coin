...
A prefix will be generated that's suitable for plugging into 405Coin's
configure. In the above example, a dir named x86_64-w64-mingw32 will be
created. To use it for 405Coin:
...
options will be passed to 405Coin Core's configure. In this case, `--disable-wallet`.

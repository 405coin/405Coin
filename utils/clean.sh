...
rm -f src/config/405Coin-config.h
...
rm -rf test_bitcoin.coverage/ 405Coin-gtest.coverage/ total.coverage/
...
clean_exe src/bench/bench_405Coin
clean_exe src/405Coin-cli
clean_exe src/405Coind
clean_exe src/405Coin-gtest
clean_exe src/test/test_405Coin
clean_exe src/test/test_405Coin_fuzzy
clean_exe src/qt/405Coin-qt
clean_exe src/qt/test/test_405Coin-qt
...
clean_dep . src/config/405Coin-config.h.in

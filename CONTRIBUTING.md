Contributing to 405Coin Core
============================

The 405Coin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/405coin/405сoin/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the 405Coin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall 405Coin
Network Protocol consensus changes.

Whether a pull request is merged into 405Coin Core rests with the project merge
...
Patches that change 405Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the 405Coin consensus, it must have been
...
The review process is normally fairly responsive on the 405Coin Core repository, however
...
The project leader is the release manager for each 405Coin Core release.

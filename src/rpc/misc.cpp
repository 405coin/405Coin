...
static UniValue validateaddress(const JSONRPCRequest &request) {
    RPCHelpMan{"validateaddress",
               "\nReturn information about the given 405Coin address.\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The 405Coin address to validate"},
               },
               RPCResult{
                       RPCResult::Type::OBJ, "", "",
                       {
    ...
    RPCHelpMan{"verifymessage",
               "\nVerify a signed message\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The 405Coin address to use for the signature."},
...
UniValue getaddressutxos(const JSONRPCRequest &request) {
    RPCHelpMan{
            ...
            "\nReturns all unspent outputs for an address (requires addressindex to be enabled).\n",
            {
                ...
                {"asset", RPCArg::Type::STR, /* default */ "405", "Get UTXOs for a particular asset instead of 405 ('*' for all assets).",}
            },
            {
                RPCResult{"For 405",
                    RPCResult::Type::ARR, "", "",
...
UniValue getaddressdeltas(const JSONRPCRequest &request) {
    RPCHelpMan{"getaddressdeltas",
               "\nReturns all changes for an address (requires addressindex to be enabled).\n",
               {
                    ...
                    {"asset", RPCArg::Type::STR, /* default */ "405", "Get all changes for a particular asset instead of 405.",}
...
static UniValue getaddressbalance(const JSONRPCRequest &request) {
    RPCHelpMan{"getaddressbalance",
               "\nReturns the balance for an address(es) (requires addressindex to be enabled).\n",
        {
            ...
            {"asset", RPCArg::Type::STR, /* default */ "405", "Get balance for a particular asset instead of 405. (\"*\" for all assets)"},
        },
        {
            RPCResult{"For 405",
                RPCResult::Type::OBJ, "", "",
...
UniValue logging(const JSONRPCRequest &request) {
    RPCHelpMan{"logging",
               ...
               "The valid logging categories are: " + LogInstance().LogCategoriesString() + "\n"
                                                                                            ...
                                                                                            "  - \"405Coin\" activates all 405Coin-specific categories at once.\n"
...
UniValue echo(const JSONRPCRequest &request) {
    RPCHelpMan{"echo|echojson ...",
               ...
               "405Coin-cli and the GUI. There is no server-side difference.",
               {},
...
static const CRPCCommand commands[] =
        { //  category              name                      actor (function)         argNames
                ...
                /* 405Coin features */
                {"405Coin",    "mnsync",                 &mnsync,                 {}},
                {"405Coin",    "spork",                  &spork,                  {"arg0",       "value"}},

...
#error Client version information missing: version is not defined by 405Coin-config.h or in any other way
#endif
...
/**
 * 405Coind-res.rc includes this file, but it cannot cope with real c++ code.

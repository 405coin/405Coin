...
HelpMessageDialog::HelpMessageDialog(interfaces::Node &node, QWidget *parent, HelpMode helpMode) :
    ...
    if (helpMode == about) {
        ...
        QString header = "Usage: 405Coin-qt [command-line options]                     \n";
...
All the 405Coin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 405, 0.01 405, 0.1 405, 1 405 and 10 405 -- sort of like the paper money you use every day.</li> \
